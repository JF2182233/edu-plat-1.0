...
const translations: Record<Language, Record<string, string>> = {
  sv: {
    ...
    'module.moduleIntro': 'Modulintro',
    'module.topic': 'Ämne',
    'module.nextTopic': 'Nästa ämne',
    'module.previousTopic': 'Föregående ämne',
    'module.topicComplete': 'Ämne klart!',
    'module.noTopics': 'Inga ämnen i denna modul ännu.',
    'module.noQuizQuestions': 'Inga quizfrågor tillgängliga.',
    ...
    'admin.moduleIntroContent': 'Modulintro (Markdown)',
    'admin.topics': 'Ämnen',
    'admin.addTopic': 'Lägg till ämne',
    'admin.topicDetails': 'Ämnesdetaljer',
    'admin.topicTitle': 'Ämnestitel',
    'admin.topicDescription': 'Ämnesbeskrivning',
    'admin.topicContentMarkdown': 'Ämnesinnehåll (Markdown)',
    'admin.topicVideoUrl': 'Ämnesvideo (URL)',
    'admin.dragToReorder': 'Dra för att sortera',
    'admin.noTopicsYet': 'Inga ämnen ännu. Lägg till ett för att komma igång.',
    'admin.noQuestionsYet': 'Inga quizfrågor ännu.',
    'admin.title': 'Titel',
  ...
  en: {
    ...
    'module.moduleIntro': 'Module intro',
    'module.topic': 'Topic',
    'module.nextTopic': 'Next topic',
    'module.previousTopic': 'Previous topic',
    'module.topicComplete': 'Topic complete!',
    'module.noTopics': 'No topics in this module yet.',
    'module.noQuizQuestions': 'No quiz questions available.',
    ...
    'admin.moduleIntroContent': 'Module intro (Markdown)',
    'admin.topics': 'Topics',
    'admin.addTopic': 'Add topic',
    'admin.topicDetails': 'Topic details',
    'admin.topicTitle': 'Topic title',
    'admin.topicDescription': 'Topic description',
    'admin.topicContentMarkdown': 'Topic content (Markdown)',
    'admin.topicVideoUrl': 'Topic video (URL)',
    'admin.dragToReorder': 'Drag to reorder',
    'admin.noTopicsYet': 'No topics yet. Add one to get started.',
    'admin.noQuestionsYet': 'No quiz questions yet.',
    'admin.title': 'Title',
